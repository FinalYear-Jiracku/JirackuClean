        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lead = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    IsUpgraded = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Columns_Sprints_SprintId",
                        column: x => x.SprintId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pages_Sprints_SprintId",
                        column: x => x.SprintId,
                        principalTable: "Sprints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_SubIssues_SubIssueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_SubIssueId",
                table: "Attachments",
                column: "SubIssueId");

            migrationBuilder.CreateIndex(
                name: "IX_Columns_SprintId",
                table: "Columns",
                column: "SprintId");
